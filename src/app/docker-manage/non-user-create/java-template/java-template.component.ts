...
@Component({
    selector: 'app-java-template',
    templateUrl: './java-template.component.html',
    styleUrls: ['./java-template.component.css']
})
export class JavaTemplateComponent implements OnInit {
        ...
        this._dockerInstructionsConfigService.getDockerInstructionsConfig().subscribe(
            res => {
                ...
                if (res) {
                    ...
                    if(this._activatedRoute.snapshot.queryParams['type'] == "java") {
                    ...
                    this.runMainInstructions = runMainKey.java;

                    let workdirKey = Object.assign({}, res.instructions.workdir);
                    this.workdirInstructions = workdirKey.java;

                    let copyKey = Object.assign({}, res.instructions.copy);
                    this.copyInstructions = copyKey.java;

                    let runDPKey = Object.assign({}, res.instructions.run_dependency);
                    this.runDependencyInstructions = runDPKey.java;
                    ...
                    this.cmdInstructions = cmdKey.java;
