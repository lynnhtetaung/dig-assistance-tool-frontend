...
@Component({
    selector: 'app-non-user-create',
    templateUrl: './non-user-create.component.html',
    styleUrls: ['./non-user-create.component.css']
})
export class NonUserCreateComponent implements OnInit {

    public filteredCountries: any[] = [];
    public selectedCountries: any[] = [];
    public selectedCountryAdvanced: any[] = [];
    public countries: any[] = [];
    public nonUserCreateForm: any;
   ...
   */
        ...
        this._dockerInstructionsConfigService.getDockerInstructionsConfig().subscribe(
            res => {
                ...
                if (res) {
                    ...
                    if(this._activatedRoute.snapshot.queryParams['type'] == "javascript") {
                    this.fromInstructions = fromKey.javascript;
                    } else if(this._activatedRoute.snapshot.queryParams['type'] == "java") {
                        this.fromInstructions = fromKey.java;
                    } else if(this._activatedRoute.snapshot.queryParams['type'] == "c") {
                        this.fromInstructions = fromKey.c;
                    } else if(this._activatedRoute.snapshot.queryParams['type'] == "python") {
                        this.fromInstructions = fromKey.python;
                    } else {
                        this.fromInstructions = [];
                        this.isOther = true;
                    }
                    ...
                    this.runMainInstructions = runMainKey.javascript;

                    let workdirKey = Object.assign({}, res.instructions.workdir);
                    this.workdirInstructions = workdirKey.javascript;

                    let copyKey = Object.assign({}, res.instructions.copy);
                    this.copyInstructions = copyKey.javascript;

                    let runDPKey = Object.assign({}, res.instructions.run_dependency);
                    this.runDependencyInstructions = runDPKey.javascript;
                    ...
                    this.cmdInstructions = cmdKey.javascript;
    ...
    setupForm() {
        ...
        this.nonUserCreateForm = this._fb.group({
        ...
        // this.nonUserCreateForm.patchValue({
        //     from: 'ubuntu'
        //   });
