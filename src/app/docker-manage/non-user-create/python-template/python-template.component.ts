...
@Component({
    selector: 'app-python-template',
    templateUrl: './python-template.component.html',
    styleUrls: ['./python-template.component.css']
})
export class PythonTemplateComponent implements OnInit {
        ...
        this._dockerInstructionsConfigService.getDockerInstructionsConfig().subscribe(
            res => {
                ...
                if (res) {
                    ...
                    if(this._activatedRoute.snapshot.queryParams['type'] == "python") {
                    ...
                    this.runMainInstructions = runMainKey.python;

                    let workdirKey = Object.assign({}, res.instructions.workdir);
                    this.workdirInstructions = workdirKey.python;

                    let copyKey = Object.assign({}, res.instructions.copy);
                    this.copyInstructions = copyKey.python;

                    let runDPKey = Object.assign({}, res.instructions.run_dependency);
                    this.runDependencyInstructions = runDPKey.python;
                    ...
                    this.cmdInstructions = cmdKey.python;
